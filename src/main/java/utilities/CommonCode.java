...
public class CommonCode {
    ...
    private WebDriverWait getWait() {
        return new WebDriverWait(
                driver,
                Duration.ofSeconds(getExplicitWaitTime())
        );
    }
    ...
    public WebElement waitForRefreshedClickable(By locator) {
        return getWait().until(
    ...
    public boolean waitForUrlToBeChanged(String oldUrl) {
        return getWait().until(
    ...
    public boolean waitForNumberOfWindows(int numberOfWindows) {
        return getWait().until(
                ExpectedConditions.numberOfWindowsToBe(numberOfWindows)
        );
    }

    public void waitForFrameAndSwitchToIt(WebElement iframeElement) {
        getWait().until(
                ExpectedConditions.frameToBeAvailableAndSwitchToIt(iframeElement)
        );
    }
    ...
    public void safeClick(By locator) {
        try {
            waitForRefreshedClickable(locator).click();
