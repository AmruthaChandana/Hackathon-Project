...
public class TC_017_MedicineAddToCart extends BaseTest {
    private static final Logger logger = LogManager.getLogger(TC_017_MedicineAddToCart.class);

    @Test
    public void verifyMedicineAddToCart() {
        logger.info("Starting TC_017 - Medicine Add To Cart");
        ...
        logger.info("Medicines found: {}", medicineCount);
        ...
        logger.info("Medicine product page opened");
        ...
        logger.info("TC_017 Passed: Add To Cart button is functioning properly");
    }
}