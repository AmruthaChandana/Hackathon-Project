...
public class TC_020_CorporateMenuOptions extends BaseTest {
    private static final Logger logger = LogManager.getLogger(TC_020_CorporateMenuOptions.class);
    private HomePage homePage;
    private CorporateWellnessPage corporatePage;

    @Test
    public void verifyCorporateMenuOptions() {
        logger.info("Starting TC_020 - Verify Corporate Menu Options");
        homePage = new HomePage(driver);

        // Step 1: Click For Corporates
        try {
            logger.info("Clicking For Corporates menu");
        ...
        commonCode.waitUntil(driver -> commonCode.getCurrentUrl().contains("/plus/corporate"));
        ...
        corporatePage.scrollDown();
        logger.info("Clicked Practo Ecosystem");

        // Step 6: Click Product Capabilities
        corporatePage.scrollToTop();
        corporatePage.clickProductCapabilities();
        corporatePage.scrollDown();
        logger.info("Clicked Product Capabilities");
        ...
        logger.info("Clicked Testimonials");

        // Step 8: Click FAQs
        corporatePage.scrollToTop();
        corporatePage.clickFAQs();
        corporatePage.scrollDown();
        logger.info("Clicked FAQs");
        ...
        logger.info("Verified user remains on Corporate Wellness page");
        logger.info("TC_020 Passed: Corporate menu options are functioning properly.");
    }
}