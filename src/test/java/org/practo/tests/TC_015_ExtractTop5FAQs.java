...
public class TC_015_ExtractTop5FAQs extends BaseTest {
    ...
    public void verifyTop5FAQsExtraction() {
        ...
        logger.info(
                "Starting TC_015 - Extract Top 5 FAQs");
        ...
        logger.info(
                "FAQ section found successfully");
        ...
        logger.info(
                "Returned from Video Consult page");

        logger.info(
                "TC_015 Passed: Extracted 5 FAQs successfully");
    }
}