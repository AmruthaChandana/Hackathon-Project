...
public class TC_014_InvalidMobileVideoConsult extends BaseTest {
    ...
    private static final Logger logger =
            LogManager.getLogger(
                    TC_014_InvalidMobileVideoConsult.class);
    ...
    public void verifyInvalidMobileNumberInVideoConsultFlow() {
        ...
        logger.info(
                "Starting TC_014 - Invalid Mobile Number Video Consult");

        homePage =
                new HomePage(driver);

        videoConsultPage =
                new VideoConsultPage(driver);
        ...
        logger.info(
                "Navigated to Video Consult page");
        ...
        commonCode.waitUntil(
                driver ->
                        commonCode.getCurrentUrl()
                                .contains("new_consultation")
                                || videoConsultPage
                                .isSymptomFieldDisplayed()
        );
        ...
        try {
            ...
            logger.warn(
                    "Specialist selection click failed. Using JavaScript click.");

            videoConsultPage.selectFirstSpecialistUsingJS();
        }

        logger.info(
                "Specialist selected successfully");
        ...
        commonCode.waitUntil(
                driver ->
                        videoConsultPage
                                .isMobileNumberFieldDisplayed());

        videoConsultPage.enterMobileNumber(
                invalidMobile);
        ...
        try {
            ...
            logger.warn(
                    "Continue button click failed. Using JavaScript click.");
        ...
        commonCode.waitUntil(
                driver ->
                        videoConsultPage
                                .isInvalidMobileMessageDisplayedInIframe());

        String invalidMessage =
                videoConsultPage
                        .getInvalidMobileMessageInIframe();
        ...
        try {
            ...
            logger.warn(
                    "OTP popup close click failed. Using JavaScript click.");

            videoConsultPage.closeOtpPopupUsingJS();
        }

        logger.info(
                "OTP/Login popup closed");
        ...
        commonCode.waitUntil(
                driver ->
                        videoConsultPage
                                .isBackToVideoConsultPageLinkDisplayed());

        try {

            videoConsultPage
                    .clickBackToVideoConsultPage();

        } catch (Exception e) {

            logger.warn(
                    "Back navigation click failed. Using JavaScript click.");

            videoConsultPage
                    .clickBackToVideoConsultPageUsingJS();
        }

        logger.info(
                "TC_014 Passed: Invalid mobile number validation message captured successfully");
    }
}