...
public class TC_007_TopCitiesVisibility extends BaseTest {
    private static final Logger logger = LogManager.getLogger(TC_007_TopCitiesVisibility.class);

    @Test
    public void verifyTopCitiesSectionVisible() {
        logger.info("Starting TC_007 - Verify Top Cities Visibility");
        ...
        logger.info("Top Cities section is visible");
        ...
        logger.info("TC_007 Passed: Top Cities section is visible");
    }
}