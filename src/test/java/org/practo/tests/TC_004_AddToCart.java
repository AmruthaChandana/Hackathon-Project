...
public class TC_004_AddToCart extends BaseTest {
    private static final Logger logger = LogManager.getLogger(TC_004_AddToCart.class);

    @Test
    public void verifyThyroidProfileAddedToCart() {
        logger.info("Starting TC_004 - Verify Thyroid Profile Add To Cart");
        ...
        commonCode.waitForUrlContains(cityName.toLowerCase());

        logger.info("Successfully navigated to city page: {}", cityName);

        // Step 3: Add Thyroid Profile To Cart
        logger.info("Adding Thyroid Profile to cart");
        page.clickThyroidAddToCart();

        commonCode.waitUntil(driver -> page.isAddedToCart());
        ...
        logger.info("Thyroid Profile added successfully");
        logger.info("Current URL: {}", driver.getCurrentUrl());
        logger.info("TC_004 Passed: Thyroid Profile added to cart successfully in {}", cityName);
    }
}