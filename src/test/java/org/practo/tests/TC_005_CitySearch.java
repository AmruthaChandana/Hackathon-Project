...
public class TC_005_CitySearch extends BaseTest {
    ...
    private static final Logger logger =
            LogManager.getLogger(
                    TC_005_CitySearch.class);

    @Test
    public void verifyCitySearchFromDropdown() {

        logger.info(
                "Starting TC_005 - Verify City Search");
        ...
        logger.info(
                "Successfully navigated to Lab Tests page"
        );

        // Step 2: Search City

        logger.info(
                "Searching city from dropdown: {}",
                cityName);

        labTestsPage.searchCity(
                cityName);
        ...
        logger.info(
                "City suggestion displayed successfully for {}",
                cityName
        );

        logger.info(
                "TC_005 Passed: City search is working successfully for {}",
                cityName
        );
    }
}