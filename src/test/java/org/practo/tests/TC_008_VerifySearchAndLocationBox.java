...
public class TC_008_VerifySearchAndLocationBox extends BaseTest {
    ...
    private static final Logger logger =
            LogManager.getLogger(
                    TC_008_VerifySearchAndLocationBox.class);
    ...
    public void verifyLocationAndSearchBoxesAreWorking(
            Map<String, String> data) {

        logger.info(
                "Starting TC_008 - Verify Search And Location Box");
        ...
        logger.info(
                "TC_008 Passed: Location and search boxes are working successfully");
    }
}