...
public class TC_018_MedicineSearchInvalid extends BaseTest {
    ...
    private static final Logger logger =
            LogManager.getLogger(
                    TC_018_MedicineSearchInvalid.class);

    @Test
    public void verifyInvalidMedicineSearch() {

        logger.info(
                "Starting TC_018 - Invalid Medicine Search");
        ...
        medicinesPage.searchInvalidMedicine(
                medicineName);
        ...
        logger.info(
                "No matching medicine found for invalid search keyword");

        logger.info(
                "TC_018 Passed: No matching medicine found for invalid medicine.");
    }
}