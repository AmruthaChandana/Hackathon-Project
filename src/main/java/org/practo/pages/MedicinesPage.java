...
public class MedicinesPage {
    ...
    @FindBy(xpath = "(//*[self::button or self::div or self::span or self::a][contains(normalize-space(),'ADD') or contains(normalize-space(),'Add') or contains(normalize-space(),'ADD TO CART') or contains(normalize-space(),'Add to Cart')])")
