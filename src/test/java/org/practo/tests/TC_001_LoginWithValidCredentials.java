...
public class TC_001_LoginWithValidCredentials extends BaseTest {
    ...
    private static final Logger logger =
            LogManager.getLogger(TC_001_LoginWithValidCredentials.class);
    ...
    public void verifyLoginWithValidCredentials() {
        ...
        String actualProfileName =
                loginPage.getDisplayedProfileName(
                        expectedProfileName);
        ...
        logger.info(
                "TC_001 Passed: User logged in successfully as: {}",
                actualProfileName);
    }
}