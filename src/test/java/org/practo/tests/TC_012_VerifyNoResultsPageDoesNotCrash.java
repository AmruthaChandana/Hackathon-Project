...
public class TC_012_VerifyNoResultsPageDoesNotCrash extends BaseTest {
    private static final Logger logger = LogManager.getLogger(TC_012_VerifyNoResultsPageDoesNotCrash.class);
    ...
    public void verifySiteDoesNotCrashWhenResultListIsEmpty(Map<String, String> data) {
        logger.info("Starting TC_012 - Verify No Results Page Does Not Crash");
        ...
        logger.info("Searching hospital with invalid keyword");
        ...
        WebElement noResultsElement = commonCode.waitForVisible(
        ...
        logger.info("No Results Message: {}", errorMessage);
        ...
        logger.info("Verified that the application displayed a valid no-results message");
        logger.info("TC_012 Passed: Site did not crash when result list was empty.");
    }
}