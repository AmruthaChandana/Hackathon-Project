...
public class TC_003_FindTest extends BaseTest {
    private static final Logger logger = LogManager.getLogger(TC_003_FindTest.class);

    @Test
    public void verifyDiabetesHealthConcernNavigation() {
        logger.info("Starting TC_003 - Verify Diabetes Health Concern Navigation");
        ...
        commonCode.waitForUrlContains("bangalore");

        // Step 3: Click Diabetes Health Concern
        logger.info("Clicking Diabetes Health Concern");
        ...
        logger.info("Successfully navigated to Diabetes Checkup page");
        logger.info("Current URL: {}", driver.getCurrentUrl());
        logger.info("TC_003 Passed: User navigated to Diabetes Checkup page successfully");
    }
}